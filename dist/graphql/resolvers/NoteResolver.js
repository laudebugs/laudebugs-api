...
let NoteResolver = class NoteResolver {
    createNote(note) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let usr = yield User_1.UserModel.findOne({ email: note.email });
                if (!usr) {
                    usr = new User_1.UserModel({ name: note.name, email: note.email });
                }
                let newNote = new Note_1.NoteModel({
...
__decorate([
    ...
    __metadata("design:paramtypes", [NoteInput]),
